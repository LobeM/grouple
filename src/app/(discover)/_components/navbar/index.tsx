...
const Navbar = async () => {
  ...
  return (
    <div className='flex px-5 py-3 items-center bg-themeBlack border-b border-themeDarkGray fixed z-50 w-full bg-clip-padding backdrop--blur__safari backdrop-filter backdrop-blur-2xl bg-opacity-60'>
